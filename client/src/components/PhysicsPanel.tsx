...
const PhysicsPanel: React.FC<PhysicsBoardProps> = ({ words, onDeleteWord, isStudyMode }) => {
    ...
    // Track selected word for detail modal
    ...
    return (
        ...
        >
            ...
            {/* Trash Icon Visual only */}
            <div
                style={{
                    position: 'absolute',
                    bottom: 15, // Unified position
                    right: isLargeScreen ? 60 : 15, // Dynamic right position
                    fontSize: 40,
                    opacity: isHoveringTrash ? 1 : 0.6,
                    transform: isHoveringTrash ? 'scale(1.2) rotate(10deg)' : 'scale(1)',
                    transition: 'all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
                    pointerEvents: 'none',
                    filter: isHoveringTrash ? 'drop-shadow(0 0 15px rgba(255, 68, 68, 0.8))' : 'none',
                    zIndex: 10
                }}
            >
                🗑️
